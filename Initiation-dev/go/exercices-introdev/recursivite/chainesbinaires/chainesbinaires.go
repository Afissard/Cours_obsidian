...
/*
Une chaîne binaire est une chaîne de caractères composée uniquement de 0 et de 1. 
On s'intéresse ici aux chaînes binaires sans 1 consécutifs. On peut générer de tels 
chaînes récursivement en considérant que
...
La fonction calculeChaines utilisera ce procédé (appliqué à chaque chaîne d'un 
tableau de chaînes) pour engendrer toutes les chaînes binaires sans 1 consécutifs 
